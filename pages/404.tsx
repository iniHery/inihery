        ...
        <div className="container">
          <div className="flex flex-wrap">
            <div className="w-full px-4 lg:w-1/2">
              <h3 className="font-semibold text-2xl text-[#00e4ff] mb-4 lg:text-3xl lg:pt-30">
                Let&apos;s be friends
              </h3>
          ...
          <div className="w-full pt-10 border-t border-[#242424]">
            <div className="flex items-center justify-center mb-4">
              ...
              <a
                href="https://instagram.com/iniheryy?igshid=ZDdkNTZiNTM="
                target="blank"
                className="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-gray-500 text-gray-500 hover:border-[#00e4ff] hover:bg-[#00e4ff] hover:text-white transition duration-300 ease-in-out"
              >
                <svg
                  role="img"
                  width={20}
            ...
            <p className="font-medium text-xs text-gray-500 text-center">
              ...
              <a
                href="https://instagram.com/iniheryy?igshid=ZDdkNTZiNTM="
                className=" text-purple-500 px-2 font-jetBrainsMono"
              >
                iniHery
              </a>
              Use
              <a href="https://tailwindcss.com/" className=" text-sky-500 pl-2">
                Tailwind CSS.
              </a>
            </p>
          </div>
